define(["jquery","underscore","vizapi/SplunkVisualizationBase","vizapi/SplunkVisualizationUtils"], function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
	    ...
	    return SplunkVisualizationBase.extend({
	        ...
	        formatData: function(data) {
	            ...
	            var min_other_percent = parseInt(this._getEscapedProperty("min_percent")) || .001;
	            var use_min_percent = this._check_boolean("use_min_percent") || "true";
	            ...
	            for (var idx = 0; idx < data.rows.length; idx++) {
	                ...
	                if ((percent <= min_other_percent) && (use_min_percent == "true")) {
	                    data.rows[idx][2] = "OTHER";
	                }
	                else {
	                    data.rows[idx][2] = data.rows[idx][0];
	                }
	                data.rows[idx][3] = idx;
	            }
	...
	//            return !(s == "0" || s == "false" || Number(s) === 0);
	        ...
	        updateView: function(data, config) {
	            ...
	            this.Do_Log("updateView");
	            this.Do_Log("Drilldown: " + allow_drilldown);
	...
	//                data_row.push(i);
	            ...
	            this.Do_Log(chartType);

	            switch (chartType) {
	                case '2D':
	//                    this.Chart_2D_Resizable(pie_data, data, max_x);
	                    this.Chart_2D_Resizable(pie_data, data, max_x);
	                    break;
	                case '3D':
	//                    this.Chart_3D_Resizable(pie_data, data);
	                    this.Chart_3D_Resizable(pie_data, data);
	                    break;
	            }
	        ...
	        Chart_3D_Resizable: function (pie_data, data) {
	            ...
	            function pieInner(d, rx, ry, h, ir) {
	             ...
	             this.Do_Log("Draw 3D donut - rework");

	            var _fields = [];
	            var chartHeight = this.$el.height();
	            var chartWidth = this.$el.width() * 0.35;
	            var legendWidth = this.$el.width() * 0.35;
	            var xcenter = 0;
	            var ycenter = 0;
	            var translate_x_pos = 0;
	            var color_scale = [];

	            var scale = chartHeight / 250;

	            var donutWidth = parseInt(this._getEscapedProperty("donutWidth")) || 20,
	                color_scheme = this._getEscapedProperty("color_scheme") || "predefined",
	                color_category = this._getEscapedProperty("color_category") || "10",
	                color_csv = this._getEscapedProperty("color_csv") || "#00ffff,#0000ff,#ff00ff,#808080,#008000,#00ff00,#800000,#000080,#808000,#800080,#ff0000,#c0c0c0,#008080,#ffff00",
	                drilldown = this._check_boolean("drilldown") || "Yes",
	                legend_text_size = parseInt(this._getEscapedProperty("legend_text_size")) || 12,
	                xradius = parseInt(this._getEscapedProperty("xradius")) || 30,
	                yradius = parseInt(this._getEscapedProperty("yradius")) || 30,
	                iradius = parseFloat(this._getEscapedProperty("iradius")) || 0.8,
	                height = parseInt(this._getEscapedProperty("height")) || 20,
	                legend_attr = {
	                    "show": this._check_boolean("show_legend") || "true",
	                    "size": parseInt(this._getEscapedProperty("legend_height")) || 12,
	                    "position": this._getEscapedProperty("legend_position") || "right",
	                    "item_width": parseInt(this._getEscapedProperty("legend_item_width")) || 200
	                };

	            this.Do_Log("Legend attr show: " + legend_attr.show + " Legend attr position: " + legend_attr.position);

	            if (color_scheme == "custom") {
	                this.Do_Log("Use custom color CSV");
	                color_scale = color_csv.split(",");
	                var color = d3.scaleOrdinal()
	                    .range(color_scale);
	                this.Do_Log("Color scale: " + color_scale);
	            }
	            else {
	               switch (color_category) {
	                    case "10":
	                        ...
	                        break;
	                    case "20":
	                        var color = d3.scaleOrdinal(["#290016","#fff949","#bc00cc","#01c121","#9c8cff","#88ff9b","#67005f","#01e6af","#780015","#c0fff2","#f98000","#014f76","#ae7300","#b1c0ff","#5f8400","#ff8a71","#019986","#5f3c00","#ffe8b8","#00593d"]);
	                        break;
	                    case "20b":
	                        var color = d3.scaleOrdinal(["#a54d52","#5cb951","#a152c6","#a4b146","#6b64d5","#d39c3b","#6c8de6","#ca5329","#5ea1d5","#d74459","#4fb89c","#d860c1","#4f803f","#cc3f83","#8a7032","#5b63a8","#dd8c67","#c18ed6","#de83a2","#944d8a"]);
	                        break;
	                    case "20c":
	                        var color = d3.scaleOrdinal(["#d8c766","#0057c8","#eec11b","#fe67e4","#8fda4b","#8c2289","#75a600","#f9216f","#00ad75","#ec3c36","#b1a6ff","#ffa335","#bb86af","#d35f00","#ffacc9","#766b00","#9e1b48","#a69a64","#953100","#5b531e"]);
	                        break;
	                }
	            }

	            xcenter = Math.min(chartWidth, chartHeight) / 2;
	            ycenter = xcenter - iradius * scale;

	            _data = d3.pie().value(function (d) {
	                return d[1];
	            })(pie_data);
	            ...
	            this.Do_Log("this.el.height: " + this.$el.height() + " - this.el.width: " + this.$el.width());
	            this.Do_Log("chartWidth: " + chartWidth + " - chartHeight: " + chartHeight + " xcenter: " + xcenter + " ycenter: " + ycenter + "  xradius: " + xradius + " yradius: " + yradius);

	            if (legend_attr.show == "true") {
	                switch (legend_attr.position) {
	                    case "right":
	                        var donut_content = d3.select(this.el).append('div')
	                            .attr("id", "donut-div")
	                            .attr("class", "donut-container");

	                        var donut_legend = d3.select(this.el).append('div')
	                    ...
	                    case "top":
	                        chartHeight = this.$el.height() / 2;
	                        chartWidth = this.$el.height() / 2;

	                        var donut_legend = d3.select(this.el).append('div')
	                            .attr("id", "donut-legend")
	                            .attr("class", "donut-container-legend-vertical");

	                        var donut_content = d3.select(this.el).append('div')
	                            .attr("id", "donut-div")
	                            .attr("class", "donut-container-vertical");
	                    ...
	                    case "bottom":
	                        ...
	                        var donut_legend = d3.select(this.el).append('div')
	                            .attr("id", "donut-legend")
	                            .attr("class", "donut-legend-vertical");
	            ...
	            if (legend_attr.show == "true") {
	                if ((legend_attr.position == "top") || (legend_attr.position == "bottom")) {

	                    var legend_chartWidth = this.$el.width();

	                    var svg = donut_content.append('svg')
	                        .attr("id", "donut-svg")
	                        .attr("class", "donut-svg-container")
	                        .attr("preserveAspectRatio", "xMidYMid meet")
	                        .attr("viewBox", "0 0 " + (chartHeight * 2) + " " + (chartHeight * 2))
	                        .append("g")
	                        .attr("transform", function() {
	                            return "translate(" + (chartWidth / 2) + "," + chartHeight + ")";
	                        });

	                    var legend_svg = donut_legend.append('svg')
	                        .attr("id", "donut-legend-svg")
	                        .attr("class", "donut-legend-svg-container")
	                        .attr("preserveAspectRatio", "xMinYMid meet")
	                        .attr("viewBox", "0 0 " + legend_chartWidth + " " + chartHeight)
	                        .append("g")
	                        .attr("transform", function() {
	                            return "translate(0" + "," + (chartHeight / 2) + ")";
	//                            return "translate(" + (chartWidth / 2) + "," + (chartHeight / 2) + ")";
	            ...
	            slices.selectAll(".innerSlice").data(_data).enter().append("path").attr("class", "innerSlice")
	                .style("fill", function (d) {
	                    return d3.hsl(color(d.data[0])).darker(0.7);
	                })
	                .attr("d", function (d) {
	                    return pieInner(d, xcenter + 0.5, ycenter + 0.5, height, iradius);
	                })
	                .each(function (d) {
	                    this._current = d;
	                });
	            ...
	            slices.selectAll(".topSlice").data(_data).enter().append("path").attr("class", "topSlice")
	                ...
	                .attr("d", function (d) {
	                    return pieTop(d, xcenter, ycenter, iradius);
	                })
	                .each(function (d) {
	                    this._current = d;
	                });
	            ...
	            slices.selectAll(".outerSlice").data(_data).enter().append("path").attr("class", "outerSlice")
	                ...
	                .attr("d", function (d) {
	                    return pieOuter(d, xcenter - 0.5, ycenter - 0.5, height);
	                })
	                .each(function (d) {
	                    this._current = d;
	                });

	            var tooltip = donut_content.append('div')
	                .attr("class", 'tooltip')

	            function mk_tooltip_function(field_cnt) {
	                return function () {
	                    return data.fields[field_cnt].name;
	                };
	            }

	            for (var field_cnt = 0; field_cnt < data.fields.length; field_cnt++) {
	                _fields[field_cnt] = data.fields[field_cnt].name;

	                tooltip.append('div')
	                    .attr("class", mk_tooltip_function(field_cnt));
	            }
	            ...
	            var topSlice = svg.selectAll('.topSlice')
	                .on('mouseover', function (d) {
	                    ...
	                    switch (legend_attr.position) {
	                        case "center":
	                            tooltip.style("left", (chartWidth - (chartWidth * 0.80)) + "px")
	                            tooltip.style("top", ((chartHeight / 2) - 10) + "px")
	                            break;
	                        case "top":
	                            tooltip.style("left", (chartWidth - (chartWidth * 0.10)) + "px")
	                            tooltip.style("top", ((chartHeight / 2) + 10) + "px")
	                            break;
	                        case "bottom":
	                            tooltip.style("left", (chartWidth - (chartWidth * 0.10)) + "px")
	                            tooltip.style("top", (chartHeight / 2) + "px")
	                            break;
	                        case "left":
	                            tooltip.style("left", (chartWidth - (chartWidth * 0.25)) + "px")
	                            tooltip.style("top", ((chartWidth / 2) - 80) + "px")
	                            break;
	                        case "right":
	                            tooltip.style("left", (chartWidth - (chartWidth * 0.25)) + "px")
	                            tooltip.style("top", ((chartWidth / 2) - 80) + "px")
	                    ...
	                    for (var row_cnt = 0; row_cnt < _fields.length; row_cnt++) {
	                        tooltip.select('.' + _fields[row_cnt]).html(_fields[row_cnt] + ": " + d.data[row_cnt]);
	                    }
	                })
	            ...
	            var legendSpacing = xcenter * 0.05;
	            var legendRectSize = xcenter * 0.10;

	            this.Do_Log("legendRectSize: " + legendRectSize + " legendSpacing: " + legendSpacing + " color.domain.length: " + color.domain().length + " legend_chartWidth: " + legend_chartWidth);
	            ...
	            if (legend_attr.show == "true") {
	                ...
	                switch (legend_attr.position) {
	                    case "left":
	                        ...
	                        legendGroup = legend_svg.append('g')
	                            .attr("class", "resizable_legend")
	                            .attr("overflow", "auto")
	                            .selectAll("g.legend")
	                            .data(color.domain().slice().reverse())
	                            .enter().append("legend_svg:g")
	...
	//                                return "translate(-80" + "," + (((chartHeight / 2) - 90) + (i * 20)) + ")"
	                            });
	                        break;
	                    ...
	                    case "right":
	                        legendGroup = legend_svg.append('g')
	                            ...
	                            .attr("transform", function (d, i) {
	                                ...
	                                var vert = i * height - offset;
	                                return "translate(" + horz + "," + vert + ")";
	//                                return "translate(20" + "," + (((chartHeight / 2) - 100) + (i * 20)) + ")"
	                            });
	                        break;
	                    ...
	                    case "top":
	                        legendGroup = legend_svg.append('g')
	                            ...
	                            .attr("transform", function(d, i) {
	                                ...
	                                var height = legendRectSize + legendSpacing;
	                                var num_per_row = Math.round(legend_chartWidth / legend_attr.item_width);
	                                var offset = legend_chartWidth / color.domain().length;
	                                var itemWidth = 250;

	                                console.log("i: " + i + " height: " + height + " offset: " + offset + " num_per_row: " + num_per_row);

	                                return "translate(" + ((i%num_per_row * itemWidth) + offset) + "," + Math.floor(i/num_per_row) * height + ")"
	                ...
	                legendGroup.append('text')
	                    ...
	                    .text(function (d) {
	                        var new_string = '';
	                        var num_truncate_chars = 0;

	//                        var string_len = d.visualLength();

	//                        console.log('string_len: ' + string_len);

	                        if (d.length > 30) {
	                            num_truncate_chars = d.length - 30;
	                            new_string = d.substr(0,(d.length - num_truncate_chars)) + "..."
	                        }
	                        else {
	                            new_string = d;
	                        }

	//                        console.log("text string: " + d + " text length: " + d.length + " new_string: " + new_string);
	...
	//                        return d
	        ...
	        Chart_2D_Resizable: function (pie_data, data, max_x) {
	            this.Do_Log("Draw 2D donut");
	            ...
	            this.Do_Log("this.el.height: " + this.$el.height() + " - this.el.width: " + this.$el.width());
	            this.Do_Log("chartWidth: " + chartWidth + " - chartHeight: " + chartHeight);

	            outerRadius = Math.min(chartWidth, chartHeight) / 2;
	            innerRadius = outerRadius - donutWidth * scale;

	            this.Do_Log("outerRadius: " + outerRadius + " - innerRadius: " + innerRadius);
	            ...
	            var ruler = d3.select(this.el).append("span")
	                .attr("id", "ruler");
	...
	//                            return "translate(" + (chartWidth / 2) + "," + (chartHeight / 2) + ")";
	            ...
	            var legendSpacing = outerRadius * 0.05;
	            var legendRectSize = outerRadius * 0.10;
	...
	//                                return "translate(20" + "," + (((chartHeight / 2) - 100) + (i * 20)) + ")"
	                    ...
	                    case "top":
	                        legendGroup = legend_svg.append('g')
	                            ...
	                            .attr("transform", function(d, i) {
	                                ...
	                                console.log("i: " + i + " height: " + height + " itemwidth: " + legend_attr.item_width + " offset: " + offset + " num_per_row: " + num_per_row);

	                                return "translate(" + ((i%num_per_row * legend_attr.item_width) + offset) + "," + Math.floor(i/num_per_row) * height + ")"
	                ...
	                String.prototype.visualLength = function (){
	                    ...
	                    document.getElementById('ruler').innerHTML = this;
	                ...
	                legendGroup.append('text')
	                    ...
	                    .text(function (d) {
	                        ...
	                        console.log("text string: " + d + " text length: " + d.length + " new_string: " + new_string + " string_len: " + string_len);
