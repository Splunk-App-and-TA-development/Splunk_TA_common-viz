import { Box3, Float32BufferAttribute, InstancedBufferGeometry, InstancedInterleavedBuffer, InterleavedBufferAttribute, Sphere, Vector3, WireframeGeometry, Vector2, ShaderLib, ShaderMaterial, UniformsLib, UniformsUtils, Mesh } from 'three';
...
LineSegments2.prototype = Object.assign(Object.create(THREE$2.Mesh.prototype), {
  ...
  computeLineDistances: function () {
    ...
    return function computeLineDistances() {
      ...
      geometry.setAttribute('instanceDistanceStart', new THREE$2.InterleavedBufferAttribute(instanceDistanceBuffer, 1, 0)); // d0

      geometry.setAttribute('instanceDistanceEnd', new THREE$2.InterleavedBufferAttribute(instanceDistanceBuffer, 1, 1)); // d1
